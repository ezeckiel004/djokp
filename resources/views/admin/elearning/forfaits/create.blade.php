        ...
        <form action="{{ route('admin.elearning.forfaits.store') }}" method="POST" class="p-6" id="forfaitForm">
            ...
            <div class="mb-6">
                ...
                <textarea name="description" rows="3"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    placeholder="Description détaillée du forfait..."></textarea>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="space-y-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="includes_qcm" value="1" checked
                            class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Inclut les QCM</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="includes_examens_blancs" value="1" checked
                            class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        <span class="ml-2 text-sm text-gray-700">Inclut les examens blancs</span>
                    </label>
                    <label class="flex items-center">
                        <input type="checkbox" name="includes_certification" value="1"
                            class="rounded border-gray-300 text-blue-600 focus:ring-blue-500">
            ...
            <div class="mb-6">
                ...
                <div id="featuresContainer" class="space-y-3">
                    <!-- Les fonctionnalités seront ajoutées ici dynamiquement -->
...
<script>
    ...
    // Ajouter une fonctionnalité initiale si le conteneur est vide

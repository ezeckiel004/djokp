                ...
                <div class="p-6" style="background: #111; border: 1px solid #333;">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-6">
                        <div class="text-center">
                            ...
                            <div class="text-sm" style="color: #888;">Durée</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold" style="color: white;">
                                {{ $formation->media->count() }}
                            </div>
                            <div class="text-sm" style="color: #888;">Ressources</div>
                        </div>
                    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="rounded-lg p-4 transition-colors duration-200"
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <h3 class="font-semibold mb-1" style="color: white;">Module {{ $index + 1 }}</h3>
            ...
            <section>
                ...
                <div class="mb-6 p-4 rounded-lg"
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <h4 class="font-bold mb-1" style="color: #3b82f6;">Ressources verrouillées</h4>
                            <p class="text-sm" style="color: #93c5fd;">
                                Les ressources multimédias sont disponibles après achat de la formation.
                        ...
                        <div class="rounded-lg overflow-hidden hover:shadow-md transition-shadow duration-200 relative"
                            ...
                            <div
                                ...
                                <div class="text-center p-4">
                                    ...
                                    <p class="font-semibold" style="color: white;">Accès réservé</p>
                                    <p class="text-sm mt-1" style="color: #ccc;">Achetez la formation pour débloquer</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 transition-colors duration-200 relative"
                            ...
                            <div
                                ...
                                <div class="text-center p-4">
                                    ...
                                    <p class="font-semibold" style="color: white;">Document verrouillé</p>
                                </div>
                            </div>
        ...
        <div class="space-y-8">
            ...
            <div class="sticky top-6">
                <div class="p-6" style="background: #111; border: 1px solid #333; border-radius: 12px;">
                    <h3 class="text-xl font-bold mb-4" style="color: var(--gold);">Réserver cette formation</h3>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="mt-6 pt-6" style="border-top: 1px solid #333;">
                            <h4 class="font-bold mb-3" style="color: white;">Questions ?</h4>
                            <div class="space-y-2">
            ...
            <div class="p-6" style="background: #111; border: 1px solid #333; border-radius: 12px;">
                <h3 class="text-lg font-bold mb-4" style="color: var(--gold);">Formations similaires</h3>
                <div class="space-y-4">
...
<section id="contact" class="py-16" style="background: #111;">
    <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl font-bold text-center mb-12" style="color: var(--gold);">Demander plus d'informations
            </h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div>
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" id="contactForm">
                        ...
                        <div>
                            <label for="nom" class="block mb-2 font-medium" style="color: #ddd;">Nom complet *</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label for="email" class="block mb-2 font-medium" style="color: #ddd;">Email *</label>
                            ...
                            <div>
                                <label for="telephone" class="block mb-2 font-medium" style="color: #ddd;">Téléphone
                                    *</label>
                        ...
                        <div>
                            <label class="block mb-2 font-medium" style="color: #ddd;">Formation concernée *</label>
                        ...
                        <div>
                            <label for="message" class="block mb-2 font-medium" style="color: #ddd;">Message *</label>
                ...
                <div>
                    <div class="p-6 rounded-lg" style="background: #1a1a1a; border: 1px solid #333;">
                        <h3 class="text-xl font-bold mb-6" style="color: var(--gold);">Contactez-nous</h3>

                        <div class="space-y-6">
                            <div>
                                <h4 class="font-semibold mb-3" style="color: white;">Par téléphone</h4>
                                <a href="tel:0176380017"
                                ...
                                <p class="text-sm mt-2" style="color: #888;">Lun-Ven: 9h-19h | Sam: 9h-13h</p>
                            </div>

                            <div>
                                <h4 class="font-semibold mb-3" style="color: white;">Par email</h4>
                                <a href="mailto:formation@djokprestige.com"
                                    class="flex items-center text-lg transition-colors duration-200 hover:text-var(--gold)"
                                    style="color: #ccc;">
                                    <i class="fas fa-envelope mr-3" style="color: var(--gold);"></i>
                            ...
                            <div>
                                <h4 class="font-semibold mb-3" style="color: white;">Notre centre</h4>
                                <div class="flex items-start">
                                    <i class="fas fa-map-marker-alt mr-3 mt-1" style="color: var(--gold);"></i>
                                    <div>
                                        <p style="color: #ccc;">DJOK PRESTIGE Formation</p>
                                        <p class="text-sm" style="color: #888;">123 Avenue des Champs-Élysées</p>
                                        <p class="text-sm" style="color: #888;">75008 Paris</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="pt-6" style="border-top: 1px solid #333;">
                                <h4 class="font-semibold mb-3" style="color: white;">Questions fréquentes</h4>
                                <div class="space-y-3">
                                    <div class="text-sm">
                                        <p class="font-medium" style="color: white;">Puis-je payer en plusieurs fois ?
                                        </p>
                                        <p style="color: #888;">Oui, nous proposons des facilités de paiement.</p>
                                    </div>
                                    <div class="text-sm">
                                        <p class="font-medium" style="color: white;">Comment utiliser mon CPF ?</p>
                                        <p style="color: #888;">Notre équipe vous accompagne dans les démarches.</p>
                                    </div>
                                    <div class="text-sm">
        ...
        if (contactForm) {
            contactForm.addEventListener('submit', function(e) {
                ...
                if (!autreServiceInput || !autreServiceInput.value.trim()) {
                    e.preventDefault();
                    alert('Erreur: La formation n\'est pas spécifiée. Veuillez rafraîchir la page.');
                    return false;
                }

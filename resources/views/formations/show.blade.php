    ...
    <div class="container mx-auto px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                <!-- Formulaire - COMME DANS formation.blade.php -->
                <div>
                    <form action="{{ route('contact.store') }}" method="POST" class="space-y-6" id="contactForm">
                        @csrf

                        <!-- EXACTEMENT COMME DANS formation.blade.php -->
                        <!-- service_id = "autre" car la formation n'est pas dans la table services -->
                        <input type="hidden" name="service_id" value="autre">

                        <!-- ICI EST LA CLÉ : Utiliser un champ hidden MAIS avec une valeur garantie non vide -->
                        @php
                        ...
                        <!-- Affichage de la formation (pour information seulement) -->
                        <div>

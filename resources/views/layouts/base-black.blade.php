...
<head>
    ...
    <title>@yield('title', 'DJOK PRESTIGE')</title>
    ...
    <style>
        ...
        * {
        ...
        /* Responsive pour les boutons flottants - CACHER SUR MOBILE */
        ...
        /* Anciens styles responsives pour référence */
        /*
        @media (max-width: 768px) {
            .floating-buttons-container {
                bottom: 20px;
...
<body class="bg-black text-white">
    ...
    <div class="min-h-screen py-12 pt-32">
        @yield('content')
    </div>
    ...
    <script>
        // Scripts pour les boutons flottants - Même que main.blade.php
